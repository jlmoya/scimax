...
//   background). mathml() output is out of scope for this port -- not
...
int
sci_mathml (fname, _pvApiCtx)
     char *fname;
     void *_pvApiCtx;
{
  pvApiCtx = _pvApiCtx;
  Scierror (9999, "SciMax (macOS port): mathml() is not supported in this build\r\n");
  return -1;
}
